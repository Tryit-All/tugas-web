                                                                    ...
                                                                    <form action="editDelete.php" method="POST">
                                                                        <div class="column">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                ...
                                                                                <input class="form-control form-white" placeholder="Enter jenis kelamin" type="text" name="kelamin" />
                                                                            </div>
                                                                        </div>
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <!-- <button type="button" class="btn btn-danger waves-effect waves-light save-category" data-dismiss="modal" name="tambah">Save</button> -->
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr class="odd">
                                                                        <form action="editDelete.php?id=<?php echo $row['id']; ?>" method="POST">
                                                                                ...
                                                                                <td><input type="email" name="email" id="email" name="email" class="formcontrol" 
                                                                                value="<?php echo $userMail; ?>"></td>
                                                                                <td><input type="number" name="tlpn" id="tlpn" pattern="[0-9]{12}" 
                                                                                onkeypress="return hanyaAngka(event)" class="form-control" value="<?php echo $userTelpon; ?>"></td>
